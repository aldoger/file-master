...
async function decrypt(encryptPath, options) {
  ...
  const decyrptMessage = decyrptFile(
    secretData.algo,
    secretData.key,
    secretData.iv,
    encryptMsg,
...
async function main() {
  ...
  AddProgram("info", "Filemaster features information", null, null, null, info);
  ...
  const downloadOpt = [
    {
      flag: "--media <media>",
      description:
        "media file you want to download (youtube, spotify, google drive, megafile, random image from internet",
    },
  ];
  ...
  const zipOpt = [
    {
      flag: "--type <type>",
      description:
        "zip files or folder you want. type files if you want to zip files. type folders if you want to zip folders",
    },
    {
      flag: "--out <out>",
  ...
  AddProgram(
    ...
    "<paths...>",
    "path to folder or files (you can only contain one type)",
    zipOpt,
    zip,
  );
  ...
  AddProgram(
    ...
    "encrypt your file",
    "<filePath>",
    "path to your file you want to encrypt",
    encryptOpt,
    encyrpt,
  );
  ...
  const decryptOpt = [
    {
      flag: "--secret <secret>",
      description:
        "path to secret file containe secret metadata of encrypted file",
    },
  ];
  ...
  AddProgram(
    ...
    "decrypt file",
    "<encryptPath>",
    "file path of your encrypted file",
    decryptOpt,
    decrypt,
  );
